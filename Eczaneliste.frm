...
Begin VB.Form Eczaneliste 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Eczaneler Nakit Listesi"
   ClientHeight    =   7020
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10380
   Icon            =   "Eczaneliste.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7020
