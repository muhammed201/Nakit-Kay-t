VERSION 5.00
Begin VB.Form huzurhakki_duzelt 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Huzur Hakký Kaydý Düzeltme"
   ClientHeight    =   4095
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9405
   Icon            =   "huzurhakkii_duzelt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4095
   ...
   End
End
Attribute VB_Name = "huzurhakki_duzelt"
...
Call tablo_ac("Select * from huzurhakki where tcno='" & Trim(Mid(Combo1.Text, 1, bul)) & "' and adi='" & Trim(Mid(Combo1.Text, bul + 3, Len(Combo1.Text) - bul + 3)) & "'")
gadi = tablo!adi
gtcno = tablo!tcno
Text1.Text = tablo!adi
Text2.Text = tablo!tcno
Text3.Text = tablo!bordro
Text4.Text = tablo!bankalist
Text5.Text = tablo!hesapno
Text6.Text = tablo!cizelge
...
Call tablo_ac("Select * from huzurhakki where tcno='" & gtcno & "' and adi='" & gadi & "'")
tablo.Edit
...
End If
tablo!bordro = Text3.Text
tablo!bankalist = Text4.Text
tablo!cizelge = Text6.Text
tablo.Update
