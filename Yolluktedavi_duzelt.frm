VERSION 5.00
Begin VB.Form Yolluktedavi_duzelt 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Yolluk(Tedavi) Nakit Kaydý Düzeltme"
   ClientHeight    =   4095
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9405
   Icon            =   "Yolluktedavi_duzelt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4095
   ...
   Begin VB.Frame Frame1 
      Caption         =   "YOLLUK(TEDAVÝ) NAKÝT KAYDI"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   162
   ...
   End
End
Attribute VB_Name = "Yolluktedavi_duzelt"
...
Call tablo_ac("Select * from yolluktedavi where tcno='" & Trim(Mid(Combo1.Text, 1, bul)) & "' and adi='" & Trim(Mid(Combo1.Text, bul + 3, Len(Combo1.Text) - bul + 3)) & "'")
gadi = tablo!adi
gtcno = tablo!tcno
...
Call tablo_ac("Select * from yolluktedavi where tcno='" & gtcno & "' and adi='" & gadi & "'")
tablo.Edit
