VERSION 5.00
Begin VB.Form Hastane_duzelt 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Hastane Nakit Kaydý Düzeltme"
   ClientHeight    =   3975
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9375
   Icon            =   "Hastane_duzelt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3975
   ...
   Begin VB.Frame Frame1 
      Caption         =   "HASTANE NAKÝT KAYDI DÜZELTME"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   162
   ...
   End
End
Attribute VB_Name = "Hastane_duzelt"
...
Call tablo_ac("Select * from hastane where tcno='" & Trim(Mid(Combo1.Text, 1, bul)) & "' and adi='" & Trim(Mid(Combo1.Text, bul + 3, Len(Combo1.Text) - bul + 3)) & "'")
gadi = tablo!adi
gtcno = tablo!tcno
...
Call tablo_ac("Select * from hastane where tcno='" & gtcno & "' and adi='" & gadi & "'")
tablo.Edit
