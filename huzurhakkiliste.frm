...
Begin VB.Form huzurhakkiliste 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Huzur Hakký Listesi"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11505
   Icon            =   "huzurhakkiliste.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8970
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   855
         Left            =   1560
         Picture         =   "huzurhakkiliste.frx":33E2
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   855
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   855
         Left            =   600
         Picture         =   "huzurhakkiliste.frx":166E6
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   855
   ...
   End
End
Attribute VB_Name = "huzurhakkiliste"
...
Flex.TextMatrix(0, 6) = "BANKA LÝST."
Flex.ColWidth(5) = 150 * 10
Flex.TextMatrix(0, 7) = "ÇÝZELGE"
Flex.ColWidth(5) = 150 * 10
Flex.TextMatrix(0, 8) = "BORDRO"
Flex.ColWidth(5) = 150 * 10
...
Flex.TextMatrix(i, 6) = tablo!bankalist
Flex.TextMatrix(i, 7) = tablo!cizelge
Flex.TextMatrix(i, 8) = tablo!bordro
tablo.MoveNext
Loop
tablo.Close
'veri.Close
