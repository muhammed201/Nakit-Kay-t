...
Begin VB.Form Poliklinikliste 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   855
         Left            =   600
         Picture         =   "Poliklinikliste.frx":33E2
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   855
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   855
         Left            =   1560
         Picture         =   "Poliklinikliste.frx":3CAC
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   855
   ...
   End
End
Attribute VB_Name = "Poliklinikliste"
...
Flex.Rows = 1
Flex.Cols = 8
Flex.TextMatrix(0, 0) = "POLÝKLÝNÝK ADI"
