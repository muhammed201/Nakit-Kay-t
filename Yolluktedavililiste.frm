...
Begin VB.Form Yolluktedavililiste 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Yolluk(Tedavi) Nakit Listesi"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11505
   Icon            =   "Yolluktedavililiste.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8970
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   855
         Left            =   1560
         Picture         =   "Yolluktedavililiste.frx":33E2
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   240
         Width           =   855
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   855
         Left            =   600
         Picture         =   "Yolluktedavililiste.frx":166E6
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   855
   ...
   End
End
Attribute VB_Name = "Yolluktedavililiste"
