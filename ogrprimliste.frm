...
Begin VB.Form ogrprimliste 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Öðrenci Sigorta Primleri Listesi"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11505
   Icon            =   "ogrprimliste.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8970
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   855
         Left            =   600
         Picture         =   "ogrprimliste.frx":166E6
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   240
         Width           =   855
   ...
   End
End
Attribute VB_Name = "ogrprimliste"
...
Flex.TextMatrix(0, 6) = "ÝSÝM LÝST."
Flex.ColWidth(5) = 150 * 10
Flex.TextMatrix(0, 7) = "TAHAKKUK"
Flex.ColWidth(5) = 150 * 10
...
Flex.TextMatrix(i, 6) = tablo!isimlist
Flex.TextMatrix(i, 7) = tablo!tahakkuk
tablo.MoveNext
Loop
tablo.Close
'veri.Close
