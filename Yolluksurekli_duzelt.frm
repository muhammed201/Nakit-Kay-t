VERSION 5.00
Begin VB.Form Yolluksurekli_duzelt 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Yolluk(Sürekli) Nakit Kaydý Düzeltme"
   ClientHeight    =   4095
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9405
   Icon            =   "Yolluksurekli_duzelt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4095
   ...
   End
End
Attribute VB_Name = "Yolluksurekli_duzelt"
...
Call tablo_ac("Select * from yolluksurekli where tcno='" & Trim(Mid(Combo1.Text, 1, bul)) & "' and adi='" & Trim(Mid(Combo1.Text, bul + 3, Len(Combo1.Text) - bul + 3)) & "'")
gadi = tablo!adi
gtcno = tablo!tcno
...
Call tablo_ac("Select * from yolluksurekli where tcno='" & gtcno & "' and adi='" & gadi & "'")
tablo.Edit
